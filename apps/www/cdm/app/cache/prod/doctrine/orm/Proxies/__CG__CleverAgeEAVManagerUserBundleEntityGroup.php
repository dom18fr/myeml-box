 ...
 */
class Group extends \CleverAge\EAVManager\UserBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'createdAt', 'updatedAt', 'familyPermissions', 'users', 'roles'];
        }
